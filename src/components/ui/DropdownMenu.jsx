...
const DropdownMenuSubTrigger = React.forwardRef(
  ({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
      ref={ref}
      className={cn(
        "flex items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-gray-100",
        inset && "pl-8",
        className
      )}
      {...props}
...
const DropdownMenuItem = React.forwardRef(
  ({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
      ref={ref}
      className={cn(
        "flex items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-gray-100 data-[disabled]:opacity-50",
        inset && "pl-8",
        className
      )}
      {...props}
